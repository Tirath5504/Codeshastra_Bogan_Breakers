...
def gen_frames():
    global good_frames
    global bad_frames
    global hand_shaking_duration
    global start_shaking_time
    global font
    global blue
    global red
    global green
    ...
    global prev_wrist_x
    global prev_wrist_y
    global no_hand_detection_start_time
    while True:
        ...
        if not success:
            ...
            # if not lmPose or not results.multi_hand_landmarks:
            #     print(start_shaking_time,hand_shaking_duration,good_frames,bad_frames)
            #     break
